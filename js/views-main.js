...
function vHome() {
  ...
  return `
    ...
    ${w ? `<div class="kpis">
      ...
      <div class="kpi"><div class="k">코카콜라만 샀다면</div><div class="v">${fmtMoney(w.coke[li])}</div><div class="s ${pctClass(w.coke[li] - w.actual[li])}">실제 대비 ${fmtMoney(w.coke[li] - w.actual[li])}</div></div>

...
function vReturns() {
  ...
  return `
    ...
    <div class="card">
      ...
      <b>실현손익은 증권사 수치와 1% 안쪽으로 맞춰져 있습니다.</b> 실제 수수료·제세금과
      체결 당시 <b>증권사 적용환율</b>(스프레드 포함)을 매매 기록에 넣어 계산합니다
      (검증: 2025년 −1.0% · 2026년 +0.4%).<br>
      남는 차이는 <b>배당금·계좌이자</b>(증권사 '총 실현수익'에는 포함, 앱은 매매만 셈)와
      일부 기록의 수수료 추정치 때문입니다. 세금 신고용 정확한 수치는 증권사 화면을 보세요.</p>
    </div>`;
}
vReturns.bind_ = (root) => {

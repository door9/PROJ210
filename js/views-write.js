...
function vSettings() {
  ...
  return `
    ...
    <div class="card">
      ...
      갱신: 각 시장이 <b>마감한 직후 하루 한 번</b> 저장소에서 알아서 종가를 받아 둡니다 —
      한국은 15:40, 미국은 05:10(서머타임) 또는 06:10(해제 시), 모두 한국시간. 주말·휴장일은 그 시장만 건너뜁니다.
      앱은 이미 받아 둔 값을 읽기만 하므로 기다릴 일이 없습니다. 지금 당장 받고 싶으면 위쪽 <b>↻</b> 버튼을 누르세요(전 종목, 약 1분).</p>
    </div>
    <div class="card">
      <h3>앱 잠금 (PIN)</h3>
      ${Lock.hasPin()
